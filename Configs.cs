...
public static class Configs
{
    ...
    // DISABLED
    public static DisabledOption FasterBeastlingCall { get; private set; } = new DisabledOption();
    public static DisabledOption SkipBeastlingCallPerformance { get; private set; } = new DisabledOption();
    ...
    // DISABLED
    public static DisabledOption FasterBossLoad { get; private set; } = new DisabledOption();

    // DISABLED
    public static DisabledOption OldFloat { get; private set; } = new DisabledOption();
    public static DisabledOption CloaklessClawline { get; private set; } = new DisabledOption();
    public static DisabledOption OldVoltVessels { get; private set; } = new DisabledOption();
    public static DisabledOption BeastBoosts { get; private set; } = new DisabledOption();
    public static DisabledOption OldScuttlebrace { get; private set; } = new DisabledOption();
    public static DisabledOption OldMist { get; private set; } = new DisabledOption();
    public static DisabledOption TrobbioSkip { get; private set; } = new DisabledOption();
    public static DisabledOption OldSkullTyrantLever { get; private set; } = new DisabledOption();
    public static DisabledOption OldPutrifiedPlanks { get; private set; } = new DisabledOption();
    ...
    // DISABLED
    public static DisabledOption SkipDreamCutsceneFully { get; private set; } = new DisabledOption();
    public static DisabledOption SkipTutorialToolMsg { get; private set; } = new DisabledOption();

    
    public static ConfigEntry<bool> SkipWeakness { get; private set; } = null!;

    // DISABLED
    public static DisabledOption InstantLevers { get; private set; } = new DisabledOption();


    public static DisabledOption FasterLifts { get; private set; } = new DisabledOption();
    public static ConfigEntry<bool> InstantText { get; private set; } = null!;
    
    
    // DISABLED
    public static DisabledOption FastUI { get; private set; } = new DisabledOption();
    public static DisabledOption SlowerOptions { get; private set; } = new DisabledOption();
